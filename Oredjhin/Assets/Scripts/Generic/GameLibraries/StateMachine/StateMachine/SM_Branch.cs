...
namespace StateMachine
{
    ...
    public class Branch : SM_BranchBase
    {
        public Branch(SM_State destinationState) : base (destinationState)
        {
            DestinationState = destinationState;
        }
        public Branch(SM_State destinationState, bool reverseInput, List<InputUnit> acceptableInputs) : base(destinationState, reverseInput, acceptableInputs)
        {
            DestinationState = destinationState;
