...
public class custom_inputs : MonoBehaviour
{
    ...
    float DescBox_X = -320;
    float InputBox_X = -100;
    float AltInputBox_X = 120;
    public float Boxes_Y = 300;

    //margin between the buttons (vertical)
    public float BoxesMargin_Y = 30;
    ...
    float resetbuttonLocX = -100;
    public float resetbuttonLocY = 600;
   ...
   void inputSetBools()
    ...
    void drawButtons1()
    {
        ...
        for (int n = 0; n < DescriptionString.Length; n++)
        {
            ...
            if (Input.GetAxis("Joystick_3a") > 0.8f && inputBool[n] == true && Event.current.keyCode != KeyCode.Escape)
            {
                // delete the key 
                inputKey[n] = KeyCode.None;
                // we don't want more input on this element
            ...
            if (Input.GetAxis("Joystick_3b") > 0.8f && inputBool[n] == true && Event.current.keyCode != KeyCode.Escape)
            {
                // delete the key 
                inputKey[n] = KeyCode.None;
                // we don't want more input on this element
            ...
            if (Input.GetAxis("Joystick_4a") > 0.8f && inputBool[n] == true && Event.current.keyCode != KeyCode.Escape)
            {
                // delete the key 
                inputKey[n] = KeyCode.None;
                // we don't want more input on this element
            ...
            if (Input.GetAxis("Joystick_4b") > 0.8f && inputBool[n] == true && Event.current.keyCode != KeyCode.Escape)
            {
                // delete the key 
                inputKey[n] = KeyCode.None;
                // we don't want more input on this element
            ...
            if (Input.GetAxis("Joystick_5a") > 0.8f && inputBool[n] == true && Event.current.keyCode != KeyCode.Escape)
            {
                // delete the key 
                inputKey[n] = KeyCode.None;
                // we don't want more input on this element
            ...
            if (Input.GetAxis("Joystick_7a") > 0.8f && inputBool[n] == true && Event.current.keyCode != KeyCode.Escape)
            {
                // delete the key 
                inputKey[n] = KeyCode.None;
                // we don't want more input on this element
            ...
            if (Input.GetAxis("Joystick_7b") > 0.8f && inputBool[n] == true && Event.current.keyCode != KeyCode.Escape)
            {
                // delete the key 
                inputKey[n] = KeyCode.None;
                // we don't want more input on this element
            ...
            if (Input.GetAxis("Joystick_8a") > 0.8f && inputBool[n] == true && Event.current.keyCode != KeyCode.Escape)
            {
                // delete the key 
                inputKey[n] = KeyCode.None;
                // we don't want more input on this element
